  ...
  var DICT = {
    zh: {
      ...
      register: {
        ...
        emailProvider: '邮箱提供商', outlook: '微软邮箱', moemail: 'MoeMail', cloudmail: 'Cloud-Mail', emailnator: 'Emailnator',
    ...
    en: {
      ...
      register: {
        ...
        emailProvider: 'Email provider', outlook: 'Microsoft', moemail: 'MoeMail', cloudmail: 'Cloud-Mail', emailnator: 'Emailnator',
    ...
    ja: {
      ...
      register: {
        ...
        emailProvider: 'メールプロバイダ', outlook: 'Microsoft', moemail: 'MoeMail', cloudmail: 'Cloud-Mail', emailnator: 'Emailnator',
