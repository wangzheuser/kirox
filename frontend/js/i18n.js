...
(function(){
  ...
  var DICT = {
    zh: {
      ...
      common: {
        loading: '加载中...', loadFailed: '加载失败', noData: '暂无数据', copy: '复制', save: '保存', cancel: '取消', confirm: '确认', delete: '删除',
        reset: '重置', clear: '清除', clearAll: '清空全部', select: '选择', close: '关闭',
        edit: '编辑', test: '测试', next: '下一步', prev: '上一步', prevPage: '上一页', nextPage: '下一页'
      },
      status: {
      ...
      register: {
        ...
        freeCustomHint: '使用 FreeCustom.Email 零配置临时邮箱进行注册。',
        fceDitpayHint: '使用 ditpay.info 固定域名的 FreeCustom.Email 临时邮箱进行注册。',
        fceJunkstopperHint: '使用 junkstopper.info 固定域名的 FreeCustom.Email 临时邮箱进行注册。',
        fceAreueallyHint: '使用 areueally.info 固定域名的 FreeCustom.Email 临时邮箱进行注册。',
        dropMailHint: '使用 DropMail 零配置临时邮箱进行注册。',
        mailCatchHint: '使用 MailCatch 零配置临时邮箱进行注册。',
        tempMailoHint: '使用 TempMailo 零配置临时邮箱进行注册。',
        minuteInboxHint: '使用 MinuteInbox 零配置临时邮箱进行注册。',
        smailProHint: '使用 SmailPro 零配置临时邮箱进行注册。',
        tempMailboxHint: '使用 TempMailbox 零配置临时邮箱进行注册。',
        generatorEmailHint: '使用 Generator.Email 零配置临时邮箱进行注册。',
        mailToWinHint: '使用 MailToWin 零配置临时邮箱进行注册。',
        mail2MeHint: '使用 Mail2Me 零配置临时邮箱进行注册。',
        pickMeMailHint: '使用 PickMeMail 零配置临时邮箱进行注册。',
        maxiMailHint: '使用 MaxiMail 零配置临时邮箱进行注册。',
        emlProHint: '使用 EmlPro 零配置临时邮箱进行注册。',
        freeMLHint: '使用 FreeML 零配置临时邮箱进行注册。',
        emlHubHint: '使用 EmlHub 零配置临时邮箱进行注册。',
        emlTmpHint: '使用 EmlTmp 零配置临时邮箱进行注册。',
        mailPwrHint: '使用 MailPwr 零配置临时邮箱进行注册。',
        tenMailHint: '使用 10Mail 零配置临时邮箱进行注册，可用域名：10mail.info、10mail.org、10mail.xyz。',
        dropMailMeHint: '使用 DropMail.me 零配置临时邮箱进行注册。',
        mimiMailHint: '使用 MimiMail 零配置临时邮箱进行注册。',
        pickMailHint: '使用 PickMail 零配置临时邮箱进行注册。',
        spyMailHint: '使用 SpyMail 零配置临时邮箱进行注册。',
        yoMailHint: '使用 YoMail 零配置临时邮箱进行注册。',
        tmioBltiwdHint: '使用 TempMailIO bltiwd.com 零配置临时邮箱进行注册。',
        tmioWnbaldwyHint: '使用 TempMailIO wnbaldwy.com 零配置临时邮箱进行注册。',
        tmioBwmygaHint: '使用 TempMailIO bwmyga.com 零配置临时邮箱进行注册。',
        tmioOzsaipHint: '使用 TempMailIO ozsaip.com 零配置临时邮箱进行注册。',
        goneBoxHint: '使用 GoneBox 零配置临时邮箱进行注册。',
        openInboxHint: '使用 OpenInbox 零配置临时邮箱进行注册。',
        blinkBoxHint: '使用 BlinkBoxApp 零配置临时邮箱进行注册。',
      ...
      toast: {
        ...
        proxySaved: '代理已保存', proxyCleared: '代理已清除', dataDirSet: '存储目录已设置', dataDirReset: '已重置为默认存储目录',
    ...
    en: {
      ...
      common: {
        loading: 'Loading...', loadFailed: 'Failed to load', noData: 'No data', copy: 'Copy', save: 'Save', cancel: 'Cancel', confirm: 'Confirm', delete: 'Delete',
        reset: 'Reset', clear: 'Clear', clearAll: 'Clear all', select: 'Select', close: 'Close',
        edit: 'Edit', test: 'Test', next: 'Next', prev: 'Previous', prevPage: 'Prev', nextPage: 'Next'
      },
      status: {
      ...
      register: {
        ...
        freeCustomHint: 'Register using FreeCustom.Email temporary mailboxes. No setup required.',
        fceDitpayHint: 'Register using FreeCustom.Email fixed-domain mailboxes at ditpay.info. No setup required.',
        fceJunkstopperHint: 'Register using FreeCustom.Email fixed-domain mailboxes at junkstopper.info. No setup required.',
        fceAreueallyHint: 'Register using FreeCustom.Email fixed-domain mailboxes at areueally.info. No setup required.',
        dropMailHint: 'Register using DropMail temporary mailboxes. No setup required.',
        mailCatchHint: 'Register using MailCatch temporary mailboxes. No setup required.',
        tempMailoHint: 'Register using TempMailo temporary mailboxes. No setup required.',
        minuteInboxHint: 'Register using MinuteInbox temporary mailboxes. No setup required.',
        smailProHint: 'Register using SmailPro temporary mailboxes. No setup required.',
        tempMailboxHint: 'Register using TempMailbox temporary mailboxes. No setup required.',
        generatorEmailHint: 'Register using Generator.Email temporary mailboxes. No setup required.',
        mailToWinHint: 'Register using MailToWin temporary mailboxes. No setup required.',
        mail2MeHint: 'Register using Mail2Me temporary mailboxes. No setup required.',
        pickMeMailHint: 'Register using PickMeMail temporary mailboxes. No setup required.',
        maxiMailHint: 'Register using MaxiMail temporary mailboxes. No setup required.',
        emlProHint: 'Register using EmlPro temporary mailboxes. No setup required.',
        freeMLHint: 'Register using FreeML temporary mailboxes. No setup required.',
        emlHubHint: 'Register using EmlHub temporary mailboxes. No setup required.',
        emlTmpHint: 'Register using EmlTmp temporary mailboxes. No setup required.',
        mailPwrHint: 'Register using MailPwr temporary mailboxes. No setup required.',
        tenMailHint: 'Register using 10Mail temporary mailboxes. Domains: 10mail.info, 10mail.org, 10mail.xyz.',
        dropMailMeHint: 'Register using DropMail.me temporary mailboxes. No setup required.',
        mimiMailHint: 'Register using MimiMail temporary mailboxes. No setup required.',
        pickMailHint: 'Register using PickMail temporary mailboxes. No setup required.',
        spyMailHint: 'Register using SpyMail temporary mailboxes. No setup required.',
        yoMailHint: 'Register using YoMail temporary mailboxes. No setup required.',
        tmioBltiwdHint: 'Register using TempMailIO bltiwd.com temporary mailboxes. No setup required.',
        tmioWnbaldwyHint: 'Register using TempMailIO wnbaldwy.com temporary mailboxes. No setup required.',
        tmioBwmygaHint: 'Register using TempMailIO bwmyga.com temporary mailboxes. No setup required.',
        tmioOzsaipHint: 'Register using TempMailIO ozsaip.com temporary mailboxes. No setup required.',
        goneBoxHint: 'Register using GoneBox temporary mailboxes. No setup required.',
        openInboxHint: 'Register using OpenInbox temporary mailboxes. No setup required.',
        blinkBoxHint: 'Register using BlinkBoxApp temporary mailboxes. No setup required.',
      ...
      toast: {
        ...
        proxySaved: 'Proxy saved', proxyCleared: 'Proxy cleared', dataDirSet: 'Data directory set', dataDirReset: 'Data directory reset to default',
    ...
    ja: {
      ...
      common: {
        loading: '読み込み中...', loadFailed: '読み込み失敗', noData: 'データなし', copy: 'コピー', save: '保存', cancel: 'キャンセル', confirm: '確認', delete: '削除',
        reset: 'リセット', clear: 'クリア', clearAll: 'すべてクリア', select: '選択', close: '閉じる',
        edit: '編集', test: 'テスト', next: '次へ', prev: '前へ', prevPage: '前へ', nextPage: '次へ'
      },
      status: {
      ...
      register: {
        ...
        guerrillaMailHint: 'GuerrillaMail の一時メールで登録します。設定は不要です。',
        fceDitpayHint: 'ditpay.info 固定ドメインの FreeCustom.Email 一時メールで登録します。設定は不要です。',
        fceJunkstopperHint: 'junkstopper.info 固定ドメインの FreeCustom.Email 一時メールで登録します。設定は不要です。',
        fceAreueallyHint: 'areueally.info 固定ドメインの FreeCustom.Email 一時メールで登録します。設定は不要です。',
        dropMailHint: 'DropMail の一時メールで登録します。設定は不要です。',
        mailCatchHint: 'MailCatch の一時メールで登録します。設定は不要です。',
        tempMailoHint: 'TempMailo の一時メールで登録します。設定は不要です。',
        minuteInboxHint: 'MinuteInbox の一時メールで登録します。設定は不要です。',
        smailProHint: 'SmailPro の一時メールで登録します。設定は不要です。',
        tempMailboxHint: 'TempMailbox の一時メールで登録します。設定は不要です。',
        generatorEmailHint: 'Generator.Email の一時メールで登録します。設定は不要です。',
        mailToWinHint: 'MailToWin の一時メールで登録します。設定は不要です。',
        mail2MeHint: 'Mail2Me の一時メールで登録します。設定は不要です。',
        pickMeMailHint: 'PickMeMail の一時メールで登録します。設定は不要です。',
        maxiMailHint: 'MaxiMail の一時メールで登録します。設定は不要です。',
        emlProHint: 'EmlPro の一時メールで登録します。設定は不要です。',
        freeMLHint: 'FreeML の一時メールで登録します。設定は不要です。',
        emlHubHint: 'EmlHub の一時メールで登録します。設定は不要です。',
        emlTmpHint: 'EmlTmp の一時メールで登録します。設定は不要です。',
        mailPwrHint: 'MailPwr の一時メールで登録します。設定は不要です。',
        tenMailHint: '10Mail の一時メールで登録します。利用可能ドメイン: 10mail.info、10mail.org、10mail.xyz。',
        dropMailMeHint: 'DropMail.me の一時メールで登録します。設定は不要です。',
        mimiMailHint: 'MimiMail の一時メールで登録します。設定は不要です。',
        pickMailHint: 'PickMail の一時メールで登録します。設定は不要です。',
        spyMailHint: 'SpyMail の一時メールで登録します。設定は不要です。',
        yoMailHint: 'YoMail の一時メールで登録します。設定は不要です。',
        tmioBltiwdHint: 'TempMailIO bltiwd.com の一時メールで登録します。設定は不要です。',
        tmioWnbaldwyHint: 'TempMailIO wnbaldwy.com の一時メールで登録します。設定は不要です。',
        tmioBwmygaHint: 'TempMailIO bwmyga.com の一時メールで登録します。設定は不要です。',
        tmioOzsaipHint: 'TempMailIO ozsaip.com の一時メールで登録します。設定は不要です。',
        goneBoxHint: 'GoneBox の一時メールで登録します。設定は不要です。',
        openInboxHint: 'OpenInbox の一時メールで登録します。設定は不要です。',
        blinkBoxHint: 'BlinkBoxApp の一時メールで登録します。設定は不要です。',
      ...
      toast: {
        ...
        proxySaved: 'プロキシを保存', proxyCleared: 'プロキシをクリア', dataDirSet: 'データディレクトリを設定', dataDirReset: 'データディレクトリをデフォルトに戻しました',
