...
func TestNewZeroConfigProvidersDoNotRequireOutlookAccounts(t *testing.T) {
	for _, provider := range []string{"mailcatch", "tempmailo", "minuteinbox", "smailpro", "tempmailbox", "generator_email", "mailtowin", "mail2me", "pickmemail", "maximail", "emlpro", "freeml", "emlhub", "emltmp", "mailpwr", "tenmail", "dropmail_me", "mimimail", "pickmail", "spymail", "yomail", "tmio_bltiwd", "tmio_wnbaldwy", "tmio_bwmyga", "tmio_ozsaip"} {
